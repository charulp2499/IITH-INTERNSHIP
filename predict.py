...
def predict(model, dataloader):
    ...
    with torch.no_grad():
        for data in dataloader:
            ...
            # Visualize the predictions for a sample
            visualize_predictions(image[0], ground_truth[0], target[0])
...
for epoch in range(TRAINING_EPOCH):
    ...
    # Call the predict function to visualize the predictions
    predict(global_model, val_dataloader)
